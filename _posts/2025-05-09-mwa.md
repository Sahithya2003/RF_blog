...
![SAR3](/RF_blog/assets/images/SAR.3png)
...
**Figure X.** CEM43 vs. distance along a radial line from the antenna tip after 300 seconds of exposure. The CEM43 value exceeds **1000 minutes** at the tip and drops below the ablation threshold of **240 minutes** around **5.5 mm**, indicating the effective thermal damage zone. The steep falloff ensures a focused ablation region with minimal impact on surrounding tissue.
